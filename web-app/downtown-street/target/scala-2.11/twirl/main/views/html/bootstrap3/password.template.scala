...
Seq[Any](format.raw/*1.88*/("""
  ...
  """),format.raw/*3.3*/("""<div class="form-group """),_display_(/*3.27*/if(field.hasErrors)/*3.46*/ {_display_(Seq[Any](format.raw/*3.48*/("""has-error""")))}),format.raw/*3.58*/("""">
    ...
    <div class="col-sm-9">
      ...
      <span class="help-block """),_display_(/*14.32*/if(field.hasErrors)/*14.51*/{_display_(Seq[Any](format.raw/*14.52*/(""" """),format.raw/*14.53*/("""er-msg red lighten-4 """)))}),format.raw/*14.75*/("""">
      """),_display_(/*15.8*/{field.error.map { error => error.message }}),format.raw/*15.52*/("""</span>
    </div>
  </div>
"""))}
  }
  ...
  def ref: this.type = this
              ...
              /*
                  ...
                  HASH: 12d282582c738eda25170d840b60d1f653c4abd6
                  MATRIX: 757->1|931->87|961->91|1011->115|1038->134|1077->136|1117->146|1189->192|1214->197|1355->312|1368->317|1391->320|1435->337|1449->342|1475->347|1520->365|1534->370|1575->390|1626->414|1658->425|1722->462|1747->466|1813->505|1841->524|1880->525|1909->526|1962->548|1998->558|2063->602
                  LINES: 26->1|29->1|31->3|31->3|31->3|31->3|31->3|32->4|32->4|37->9|37->9|37->9|38->10|38->10|38->10|39->11|39->11|39->11|40->12|40->12|41->13|41->13|42->14|42->14|42->14|42->14|42->14|43->15|43->15
                  -- GENERATED --
              */
